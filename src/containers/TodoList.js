...
export default function TodoList() {
  ...
  return (
    <React.Fragment>
      ...
      <button className="sort-button" onClick={sortHandler}>Sort Todos (ABC)</button>
      ...
      <section className="main">
        ...
        <ul className="todo-list">
          {visibleTodos.filter(visibleTodo => {
            const todoCheck = visibleTodo.label.toLowerCase().includes(filterTodos.toLowerCase());
            if (todoCheck) return visibleTodo;
          }).map(todo => (
